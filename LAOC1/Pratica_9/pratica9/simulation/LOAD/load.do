...
add wave -noupdate -label Addres -radix binary /system/mem1/addr
...
add wave -noupdate -label {Control ALU} -radix hexadecimal /system/proc1/controlAlu
...
add wave -noupdate -label {Write Enable} /system/proc1/rf/RegWrite
...
add wave -noupdate -label {Reg 3} -radix hexadecimal {/system/proc1/rf/register[3]}
add wave -noupdate -label {Reg 2} -radix hexadecimal {/system/proc1/rf/register[2]}
...
WaveRestoreCursors {{Cursor 1} {1224 ps} 0}
